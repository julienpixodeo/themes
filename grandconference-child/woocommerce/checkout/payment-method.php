	...
	<label for="payment_method_<?php echo esc_attr( $gateway->id ); ?>">
        <?php 
            ...
            if($id_ticket != 0){
                ...
                if($lan === 'french' && $gateway_title === 'Credit Card (Stripe)'){
                    $gateway_title = 'Carte de crédit (Stripe)';
                }
            }
        ?>
		<?php 
        echo $gateway_title; /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?>
