<?php
	...
	if(is_page() OR is_single() OR (class_exists('Woocommerce') && grandconference_is_woocommerce_page()))
	{
		...
		{
			$tg_header_content_default = get_post_meta($current_page_id, 'page_header', true);
		...
		{
			$tg_transparent_header_content_default = get_post_meta($current_page_id, 'page_transparent_header', true);
	...
	<div id="elementor-header" class="main-menu-wrapper">
		<?php 
			if (class_exists("\\Elementor\\Plugin")) {
                echo grandconference_get_elementor_content($tg_header_content_default);
            }
		?>
	</div>
<?php
