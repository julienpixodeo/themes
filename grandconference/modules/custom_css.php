...
<?php
	$tg_content_bg_color = get_theme_mod('tg_content_bg_color', '#ffffff');
	$tg_h1_font_color = get_theme_mod('tg_h1_font_color', '#000000');
?>
...
<?php
	$tg_sidemenu_font_size = get_theme_mod('tg_sidemenu_font_size', 24);
...
<?php
	$tg_sidemenu_bg = get_theme_mod('tg_sidemenu_bg', '#ffffff');
	$tg_sidemenu_bg_opacity = get_theme_mod('tg_sidemenu_bg_opacity', 85);
...
<?php
	$tg_menu_layout = grandconference_menu_layout();
	$tg_sidemenu_align = get_theme_mod('tg_sidemenu_align', 'right');
	$tg_sidemenu_width = get_theme_mod('tg_sidemenu_width', 360);
...
<?php
	...
	$tg_smart_fixed_menu = get_theme_mod('tg_smart_fixed_menu', 1);
...
<?php
	...
	$tg_page_title_vertical_alignment = get_theme_mod('tg_page_title_vertical_alignment', 'baseline');
...
<?php
	...
	$tg_menu_shadow = get_theme_mod('tg_menu_shadow', 1);
...
<?php
	$tg_topbar = get_theme_mod('tg_topbar', 0);
...
<?php
	...
	$tg_boxed_bg_image = get_theme_mod('tg_boxed_bg_image', 0);
...
<?php
	...
	if(GRANDCONFERENCE_THEMEDEMO)
	{
		$tg_button_bg_color = get_theme_mod('tg_button_bg_color', '#FF2D55');
?>
